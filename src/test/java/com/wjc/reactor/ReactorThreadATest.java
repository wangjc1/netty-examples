...
/**
 * 1个线程Acceptor接受客户端的连接，然后由一组IO线程（Reactor）来执行网络的读写
 *
 * @author: wangjc
 * 2017/7/20
 */
public class ReactorThreadATest {
     ...
     * @author dingwei2
     */
    private static class NioReactorThreadGroup {
...
//              ? 2 * (Runtime.getRuntime().availableProcessors() - 1 ) : 2;
     ...
     * @author dingwei2
     */
    private static class NioReactorThread extends Thread {
